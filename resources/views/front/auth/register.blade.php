...
<div class="row m-3"> 	
        ...
        <div class="col-md-4 offset-md-4">
			...
			<img class="logow logores w-50 mx-auto" src="https://demo.ramsthemes.com/projects/exlibriswp/wp-content/uploads/2019/07/exlibris-logo-normal.svg" alt="Normal Mode Logo">
						
						<!-- display logo for dark mode -->
			<img class="logob logores w-50 mx-auto" src="https://demo.ramsthemes.com/projects/exlibriswp/wp-content/uploads/2019/07/exlibris-logo-dark.svg" alt="Dark Mode Logo">
							
						<!-- display logo for normal mode -->
			<img class="logow d-md-none w-50 mx-auto" src="https://demo.ramsthemes.com/projects/exlibriswp/wp-content/uploads/2019/07/exlibris-logo-normal-res.svg" alt="Normal Mode Logo">
							
						<!-- display logo for dark mode -->
			<img class="logob d-md-none w-50 mx-auto" src="https://demo.ramsthemes.com/projects/exlibriswp/wp-content/uploads/2019/07/exlibris-logo-dark-res.svg" alt="Dark Mode Logo">
            ...
            @csrf
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						...
						<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
							...
							<input type="password" class="woocommerce-Input woocommerce-Input--text input-text @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" />
                            @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
