                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                ...
                                                <span class="number"><a href="{{ route('admin.users.index') }}">{{ $users }}</a></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="footer">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                ...
                                                <span class="number"><a href="{{ route('admin.products.index') }}">{{ $products }}</a></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="footer">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                ...
                                                <span class="number"><a href="{{ route('admin.orders.index') }}">{{ $orders }}</a></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="footer">
